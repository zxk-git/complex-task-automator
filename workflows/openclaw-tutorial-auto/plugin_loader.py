...
VALID_HOOKS = frozenset([
    "before_discover", "after_discover",
    "before_scan", "after_scan",
    "before_analyze", "after_analyze",
    "before_collect_refs", "after_collect_refs",
    "before_check_links", "after_check_links",
    "before_check_consistency", "after_check_consistency",
    "before_check_readability", "after_check_readability",
    "before_fix_issues", "after_fix_issues",
    "before_refine", "after_refine",
    "before_format", "after_format",
    "before_track", "after_track",
    "before_update_readme", "after_update_readme",
