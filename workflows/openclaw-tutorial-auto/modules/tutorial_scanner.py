...
_RE_FAQ = re.compile(r"##\s.*(?:常见问题|FAQ)", re.IGNORECASE)
_RE_SUMMARY = re.compile(r"##\s.*(?:本章小结|小结|Summary)", re.IGNORECASE)
_RE_REFERENCES = re.compile(r"##\s.*(?:参考来源|参考链接|参考|References)", re.IGNORECASE)
